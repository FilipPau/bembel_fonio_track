# Contributing to appointment-manager

Thank you for your interest in contributing to appointment-manager! Your help is greatly appreciated. Please follow these guidelines to make the process smooth for everyone.

---

## 🐞 Reporting Issues

- Search [existing issues](https://github.com/angularcafe/appointment-manager/issues) before opening a new one.
...
- Check if your idea already exists in [issues](https://github.com/angularcafe/appointment-manager/issues).
...
- For questions, open a [discussion](https://github.com/angularcafe/appointment-manager/discussions) or [issue](https://github.com/angularcafe/appointment-manager/issues).
- You can also reach out to [@immohammadjaved](https://x.com/immohammadjaved) on X (Twitter).

---

Thank you for helping make appointment-manager better! 🎉
